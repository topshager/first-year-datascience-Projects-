...
# Load both datasets
data1 = pd.read_csv('#CSV location file path dataset 1/Data scince project /dataset_1.csv')
data2 = pd.read_csv('#CSV location file path dataset 2/Data scince project /dataset_2.csv')
